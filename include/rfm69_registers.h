...
// RFM69HCW Register Definitions

#define REG_FIFO            0x00 // FIFO read/write access
#define REG_OPMODE          0x01 // Operating modes of the transceiver
#define REG_DATAMODUL       0x02 // Data operation mode and Modulation settings
#define REG_BITRATEMSB      0x03 // Bit Rate setting Most Significant Bits
#define REG_BITRATELSB      0x04 // Bit Rate setting Least Significant Bits
#define REG_FDEVMSB         0x05 // Frequency Deviation setting Most Significant Bits
#define REG_FDEVLSB         0x06 // Frequency Deviation setting Least Significant Bits
#define REG_FRFMSB          0x07 // RF Carrier Frequency Most Significant Bits
#define REG_FRFMID          0x08 // RF Carrier Frequency Intermediate Bits
#define REG_FRFLSB          0x09 // RF Carrier Frequency Least Significant Bits
#define REG_OSC1            0x0A // RC Oscillators Settings
#define REG_AFCCTRL         0x0B // AFC control in low modulation index situations
// 0x0C Reserved
...
#define REG_VERSION         0x10 // Version code of the chip
#define REG_PALEVEL         0x11 // PA selection and Output Power control
#define REG_PARAMP          0x12 // Control of the PA ramp time in FSK mode
#define REG_OCP             0x13 // Over Current Protection control
// 0x14 to 0x17 Reserved
#define REG_LNA             0x18 // LNA settings
#define REG_RXBW            0x19 // Channel Filter BW Control
#define REG_AFCBW           0x1A // Channel Filter BW control during the AFC routine
#define REG_OOKPEAK         0x1B // OOK demodulator selection and control in peak mode
#define REG_OOKAVG          0x1C // Average threshold control of the OOK demodulator
#define REG_OOKFIX          0x1D // Fixed threshold control of the OOK demodulator
#define REG_AFCFEI          0x1E // AFC and FEI control and status
#define REG_AFCMSB          0x1F // MSB of the frequency correction of the AFC
#define REG_AFCLSB          0x20 // LSB of the frequency correction of the AFC
#define REG_FEIMSB          0x21 // MSB of the calculated frequency error
#define REG_FEILSB          0x22 // LSB of the calculated frequency error
#define REG_RSSICONFIG      0x23 // RSSI-related settings
#define REG_RSSIVALUE       0x24 // RSSI value in dBm
#define REG_DIOMAPPING1     0x25 // Mapping of pins DIO0 to DIO3
#define REG_DIOMAPPING2     0x26 // Mapping of pins DIO4 and DIO5 ClkOut frequency
#define REG_IRQFLAGS1       0x27 // Status register: PLL Lock state, Timeout, RSSI > Threshold...
#define REG_IRQFLAGS2       0x28 // Status register: FIFO handling flags...
#define REG_RSSITHRESH      0x29 // RSSI Threshold control
#define REG_RXTIMEOUT1      0x2A // Timeout duration between Rx request and RSSI detection
#define REG_RXTIMEOUT2      0x2B // Timeout duration between RSSI detection and PayloadReady
#define REG_PREAMBLEMSB     0x2C // Preamble length MSB
#define REG_PREAMBLELSB     0x2D // Preamble length LSB
#define REG_SYNCCONFIG      0x2E // Sync Word Recognition control
#define REG_SYNCVALUE1      0x2F // Sync Word bytes 1 through 8
// Registers 0x30 to 0x3D are omitted for brevity; repeat the pattern as needed
#define REG_PACKETCONFIG1   0x37 // Packet mode settings
#define REG_PAYLOADLENGTH   0x38 // Payload length setting
#define REG_NODEADRS        0x39 // Node address
#define REG_BROADCASTADRS   0x3A // Broadcast address
#define REG_AUTOMODES       0x3B // Auto modes settings
#define REG_FIFOTHRESH      0x3C // Fifo threshold, Tx start condition
#define REG_PACKETCONFIG2   0x3D // Packet mode settings
#define REG_AESKEY1         0x3E // First byte of the AES key
// AES Key Registers
#define REG_AESKEY2         0x3F // Second byte of the AES key
#define REG_AESKEY3         0x40 // Third byte of the AES key
#define REG_AESKEY4         0x41 // Fourth byte of the AES key
#define REG_AESKEY5         0x42 // Fifth byte of the AES key
#define REG_AESKEY6         0x43 // Sixth byte of the AES key
#define REG_AESKEY7         0x44 // Seventh byte of the AES key
#define REG_AESKEY8         0x45 // Eighth byte of the AES key
#define REG_AESKEY9         0x46 // Ninth byte of the AES key
#define REG_AESKEY10        0x47 // Tenth byte of the AES key
#define REG_AESKEY11        0x48 // Eleventh byte of the AES key
#define REG_AESKEY12        0x49 // Twelfth byte of the AES key
#define REG_AESKEY13        0x4A // Thirteenth byte of the AES key
#define REG_AESKEY14        0x4B // Fourteenth byte of the AES key
#define REG_AESKEY15        0x4C // Fifteenth byte of the AES key
#define REG_AESKEY16        0x4D // Sixteenth byte of the AES key
#define REG_TEMP1           0x4E // Temperature Sensor control
#define REG_TEMP2           0x4F // Temperature readout
#define REG_TESTLNA         0x58 // Sensitivity boost
#define REG_TESTPA1         0x5A // High Power PA settings
#define REG_TESTPA2         0x5C // High Power PA settings
#define REG_TESTDAGC        0x6F // Fading Margin Improvement
#define REG_TESTAFC         0x71 // AFC offset for low modulation index AFC
